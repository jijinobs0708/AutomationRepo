...
public class ExcelUtility {
	...
	public static String getStringData(int a, int b, String sheet) throws IOException {
		...
		XSSFRow r = sh.getRow(a);// inbuilt class in apache,to read the details from row, getRow is a method used
									// to get details from row
		XSSFCell c = r.getCell(b); // inbuilt class in apache,to get the details of value from cell, getCell is a
									// method used to get value from value. r.getCell - as its inside row we use r.
	...
	public static int getIntData(int a, int b, String sheet) throws IOException {
		...
		// return String.valueOf(d); //Valueof() - method used for type conversion-as we
		// want the o/p
		return (d);
	}
